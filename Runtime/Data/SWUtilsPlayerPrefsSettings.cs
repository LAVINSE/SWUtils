...
{
    /// <summary>
    /// SWUtilsPlayerPrefs 암호화 설정을 보관하는 ScriptableObject입니다.
    /// 프로젝트의 Resources 폴더에 같은 이름으로 생성하면 런타임에서 자동으로 사용합니다.
    /// </summary>
    public class SWUtilsPlayerPrefsSettings : ScriptableObject
    {
        /// <summary>Resources 폴더에서 찾는 설정 에셋 이름입니다.</summary>
        public const string ResourceAssetName = "SWUtilsPlayerPrefsSettings";

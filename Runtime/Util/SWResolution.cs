...
namespace SW.Util
{
    /// <summary>
    /// 해상도 관련 정적 유틸리티.
    /// 에디터에서는 Game View 카메라의 픽셀 크기를, 빌드에서는 Screen 크기를 사용합니다.
    /// 해상도/방향 변경 이벤트도 전역으로 제공합니다.
    /// </summary>
    public static class SWResolution
    {
        #region 필드
        ...
        /// 사용하려면 SWResolution.StartWatcher()를 한 번 호출해야 합니다.
        /// </summary>
        ...
        /// <summary>
        /// 현재 화면 너비(픽셀).
        /// 에디터에서는 메인 카메라의 pixelWidth를 반환합니다.
        /// </summary>
        ...
        /// <summary>
        /// 현재 화면 높이(픽셀).
        /// 에디터에서는 메인 카메라의 pixelHeight를 반환합니다.
        /// </summary>
        ...
        /// <summary>현재 화면 크기를 Vector3로 반환합니다. (z = 0)</summary>
        public static Vector3 ScreenSize => new Vector3(ScreenWidth, ScreenHeight, 0f);

        /// <summary>현재 화면 크기를 Vector2로 반환합니다.</summary>
        ...
        public static void StartWatcher()
        {
            ...
            var watcherObject = new GameObject("[SWResolutionWatcher]");
        ...
        {
            /// <summary>매 프레임 해상도 변경을 확인합니다.</summary>
            private void Update()
            {
        ...
        #region 해상도 스케일
        /// <summary>
        /// 기준 해상도 비율(scale.x / scale.y)로 계산한 너비를 반환합니다.
        /// 화면 높이에 비율을 곱하여 필요한 너비를 산출합니다.
        /// </summary>
        ...
        /// <summary>
        /// 기준 해상도에 맞추기 위한 스케일 비율을 반환합니다.
        /// 현재 화면이 기준보다 좁으면 축소 비율(0~1), 넓으면 1을 반환합니다.
        /// </summary>
        ...
        /// <summary>
        /// 프로젝트 기준 해상도(BaseWidth, BaseHeight)에 맞추기 위한 스케일 비율을 반환합니다.
        /// </summary>
        /// <returns>적용할 스케일 비율</returns>
        ...
        /// <summary>
        /// 특정 비율(width / height) 기준으로 현재 화면이 더 좁은지 여부를 반환합니다.
        /// </summary>
        ...
        #region 레터박스 / 필러박스
        /// <summary>
        /// 기준 비율 대비 현재 화면에서 발생할 레터박스(상하 여백) 크기를 반환합니다.
        ...
        /// <summary>
        /// 기준 비율 대비 현재 화면에서 발생할 필러박스(좌우 여백) 크기를 반환합니다.
        ...
        #region 좌표 변환
        /// <summary>
        /// 스크린 좌표 (0,0)~(ScreenWidth, ScreenHeight)를 0~1 정규화된 UV 좌표로 변환합니다.
        /// </summary>
        ...
        /// <summary>
        /// 현재 화면의 월드 공간 경계 좌표를 반환합니다. (지정 카메라의 Z 거리 기준)
        /// </summary>
        ...
        #region DPI
        /// <summary>
        /// DPI를 고려하여 물리적 크기(인치)를 픽셀 크기로 변환합니다.
        /// Screen.dpi가 0이면 96 DPI로 가정합니다.
        /// </summary>
        ...
        /// <summary>
        /// DPI를 고려하여 픽셀 크기를 물리적 크기(인치)로 변환합니다.
        /// Screen.dpi가 0이면 96 DPI로 가정합니다.
        /// </summary>
        ...
        /// <summary>
        /// 접근성 가이드라인에 따른 최소 터치 타겟 크기를 픽셀로 반환합니다.
        ...
        #region 카메라 FOV
        /// <summary>
        /// 수평 FOV를 수직 FOV로 변환하여 카메라에 적용합니다.
        /// Unity 카메라는 기본적으로 수직 FOV를 사용하므로, 수평 FOV 기준으로 일관된 시야를 유지하고 싶을 때 사용합니다.
        /// </summary>
        ...
        /// <summary>
        /// 카메라의 현재 수직 FOV로부터 수평 FOV를 계산하여 반환합니다.
        /// </summary>
        ...
        /// <summary>
        /// Orthographic 카메라의 크기를 기준 해상도 기준으로 자동 조정합니다.
        /// 세로가 짧은 기기에서 orthographicSize를 키워 더 넓은 영역이 보이게 합니다.
        /// </summary>

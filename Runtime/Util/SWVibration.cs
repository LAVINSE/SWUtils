...
namespace SW.Util
{
    ...
    public static class SWVibration
    {
        ...
        /// <summary>
        /// 진동 사용 여부를 SWPlayerPrefs에 저장합니다.
        /// </summary>
        /// <param name="key">저장에 사용할 키입니다.</param>
        public static void SaveEnabled(string key = EnabledPrefsKey)
        {
            SWPlayerPrefs.SetBool(key, isEnabled);
            SWPlayerPrefs.Save();
        }

        /// <summary>
        /// SWPlayerPrefs에 저장된 진동 사용 여부를 불러옵니다.
        /// </summary>
        ...
        {
            isEnabled = SWPlayerPrefs.GetBool(key, defaultValue);
        }
        #endregion // 설정
        ...
        private static AndroidJavaObject GetAndroidVibrator()
        {
            ...
            {
                SWLog.LogWarning($"[SWVibration] Failed to get Android vibrator: {exception.Message}");
                return null;
            }
        }
        ...
        private static bool HasAndroidVibrator()
        {
            ...
            {
                SWLog.LogWarning($"[SWVibration] Failed to check Android vibrator: {exception.Message}");
                return false;
            }
        }
        ...
        private static void VibrateAndroid(long milliseconds, int amplitude)
        {
            ...
            {
                SWLog.LogWarning($"[SWVibration] Android vibration failed: {exception.Message}");
            }
        }
        ...
        private static void PatternAndroid(long[] timings, int[] amplitudes, int repeat)
        {
            ...
            {
                SWLog.LogWarning($"[SWVibration] Android pattern failed: {exception.Message}");
            }
        }

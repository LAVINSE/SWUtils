...
namespace SW.Util
{
    ...
    /// OnTriggerEnter/Stay/Exit 이벤트를 외부에서 구독할 수 있게 합니다.
    /// </summary>
    public class SWTriggerDispatcher : MonoBehaviour
    {
        #region 프로퍼티
        /// <summary>3D 트리거 Enter 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider> EnterCallback { get; set; } = null;
        /// <summary>3D 트리거 Stay 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider> StayCallback { get; set; } = null;
        /// <summary>3D 트리거 Exit 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider> ExitCallback { get; set; } = null;

        /// <summary>2D 트리거 Enter 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider2D> Enter2DCallback { get; set; } = null;
        /// <summary>2D 트리거 Stay 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider2D> Stay2DCallback { get; set; } = null;
        /// <summary>2D 트리거 Exit 콜백.</summary>
        public System.Action<SWTriggerDispatcher, Collider2D> Exit2DCallback { get; set; } = null;
        #endregion // 프로퍼티

        #region 함수
        /// <summary>
        /// 3D 트리거에 접촉했을 때 호출됩니다.
        /// </summary>

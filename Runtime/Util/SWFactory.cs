...
namespace SW.Util
{
    ...
    /// 일반 생성, 프리팹 복제, 제네릭 컴포넌트 반환을 지원합니다.
    /// </summary>
    public class SWFactory : MonoBehaviour
    {
        #region 함수
        /// <summary>
        /// 게임 객체를 생성합니다.
            ...
            Vector3 scale, Vector3 rotation, bool isStayWorldPosition = false)
        {
            ...
            {
                SWLog.LogError($"[SWFactory] 프리팹 복제 실패: 원본 프리팹이 null입니다. ObjectName: {objectName}");
                return null;
            }
        ...
        {
            var gameObject = SWFactory.CreateGameObj(objectName,
        ...
        /// <summary>
        /// 프리팹을 복제하여 사본 객체를 생성합니다. (제네릭, 컴포넌트 반환)
        /// </summary>
        /// <typeparam name="T">반환할 컴포넌트 타입</typeparam>
        /// <param name="objectName">객체 이름</param>
        /// <param name="prefabObject">복제할 프리팹</param>
        ...
        public static T CreateCloneGameObj<T>(string objectName,
            ...
            bool isStayWorldPosition = false) where T : Component
        {
            var gameObject = SWFactory.CreateCloneGameObj(objectName,

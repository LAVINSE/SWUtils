...
namespace SW.Attributes
{
    ...
    /// Inspector에서 열거형 필드의 값에 따라 다른 필드의 표시 여부를 제어할 때 사용합니다.
    /// </summary>
    /// <example>
    /// <code>[SWEnumCondition("열거형필드이름", 열거형인덱스)]</code>
    /// </example>
    ...
    public class SWEnumConditionAttribute : PropertyAttribute
    {
        ...
        /// <summary>
        /// 조건 열거형 필드 이름과 표시할 열거형 값을 지정해 조건부 표시 어트리뷰트를 생성합니다.
        /// </summary>
        /// <param name="conditionEnum">조건으로 사용할 열거형 필드 이름입니다.</param>
        /// <param name="enumValues">필드를 표시할 열거형 값 목록입니다.</param>
        ...
        /// <summary>
        /// 지정한 열거형 값이 표시 조건에 포함되어 있는지 확인합니다.
        /// </summary>
        /// <param name="enumValue">확인할 열거형 값입니다.</param>
